import { r as reactExports, U as jsxRuntimeExports } from "./worker-entry-D3RwNIBS.js";
...
import { u as useMediaStore, t as toast } from "./router-CYwdL5gl.js";
import "node:events";
...
const previewBackground = "/assets/preview_a4-CFDDWTBw.png";
function Slideshow({
  items,
  startIndex = 0,
  onClose,
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/80 to-transparent p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-4xl", children: [
          (current.eventName.trim() || current.tag.trim()) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs uppercase tracking-[0.2em] text-white/60", children: [current.eventName.trim(), current.tag.trim()].filter(Boolean).join(" · ") }),
...
const canvasToA4PdfBlob = async (canvas) => {
  const {
    jsPDF
  } = await import("./jspdf.es.min-BY909d4r.js").then((n) => n.j);
...
function PreviewPage() {
  ...
  const slideshowResumeAudioRef = reactExports.useRef(false);
  ...
  reactExports.useEffect(() => {
    if (slideshowAt === null) {
      if (slideshowResumeAudioRef.current && bgAudioRef.current && bgAudioUrl && bgAudio && playing) {
    ...
    slideshowResumeAudioRef.current = Boolean(bgAudioRef.current && bgAudioUrl && bgAudio && playing);
  ...
  const generateExportBlob = async (format) => {
  ...
  const exportAs = async (format) => {
    ...
    try {
      ...
      toast.success(format === "png" ? "PNG exported successfully!" : "PDF exported successfully!");
    } finally {
      setExporting(false);
    }
  };
  const handleShare = async () => {
    ...
    try {
      ...
      if (typeof navigator !== "undefined" && "share" in navigator && "canShare" in navigator && navigator.canShare?.({
        files: [file]
      })) {
      ...
      downloadBlob(result.blob, result.fileName);
      const whatsappText = encodeURIComponent(`${shareText} The PDF has been downloaded on this device. Attach it in WhatsApp to send.`);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "mx-auto max-w-6xl px-6 py-12", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass mb-6 flex flex-wrap items-center gap-3 rounded-2xl p-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-auto flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "share", className: "rounded-full", disabled: exporting || sharing, onClick: handleShare, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Share2, { className: "mr-2 h-4 w-4" }),
            sharing ? "Sharing..." : "Share"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", className: "rounded-full", disabled: exporting || sharing, onClick: () => exportAs("pdf"), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "mr-2 h-4 w-4" }),
            exporting ? "Exporting…" : "Export PDF"
          ] }),
          isSingleA4Preview && /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", className: "rounded-full", disabled: exporting || sharing, onClick: () => exportAs("png"), children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden rounded-3xl border border-border shadow-[var(--shadow-elegant)]", style: {
        backgroundImage: `linear-gradient(rgba(255, 255, 255, 0.82), rgba(255, 255, 255, 0.82)), url(${previewBackground})`,
        backgroundPosition: "center top",
        backgroundRepeat: "repeat-y",
        backgroundSize: "100% auto"
      }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: gridRef, className: "relative p-3 sm:p-5 sm:columns-2 lg:columns-3 [column-fill:_balance] [column-gap:12px] lg:[column-gap:18px]", children: items.map((item, i) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { onClick: () => setSlideshowAt(i), role: "button", tabIndex: 0, onKeyDown: (e) => {
          ...
          }, className: "group relative mb-3 block w-full cursor-pointer overflow-hidden rounded-2xl bg-background/90 text-left shadow-[var(--shadow-card)] break-inside-avoid focus:outline-none focus-visible:ring-2 focus-visible:ring-primary lg:mb-4", style: {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pointer-events-none absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/90 to-transparent p-3", children: [
              item.eventName.trim() ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold text-white", children: item.eventName }) : null,
              item.tag.trim() ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-white/70", children: item.tag }) : null
            ] })
          ] }, item.id);
        }) }),
        items.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative py-20 text-center text-sm text-slate-600", children: "Upload media to generate a preview." })
      ] }),
      ...
      slideshowAt !== null && /* @__PURE__ */ jsxRuntimeExports.jsx(Slideshow, { items, startIndex: slideshowAt, onClose: handleCloseSlideshow })
    ] }),
