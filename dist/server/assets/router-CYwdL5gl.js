...
const getAvailability = (url) => {
  if (!url) return "session-only";
  if (url.startsWith("http://") || url.startsWith("https://")) {
    return "remote";
  }
  return "session-only";
};
const buildMobileDraftSnapshot = ({
  items,
  bgAudio,
  bgAudioName
}) => ({
...
const appCss = "/assets/styles-cDGVnVOC.css";
...
function RootComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(MobileDraftSync, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Toaster2, { position: "bottom-right" })
  ] });
}
const $$splitComponentImporter$4 = () => import("./preview-DXf-A3NC.js");
const Route$4 = createFileRoute("/preview")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$3 = () => import("./landing-Dk2Fm42Z.js");
const Route$3 = createFileRoute("/landing")({
  head: () => ({
    meta: [{
      title: "MemoryWall — Special Occasion Gifts"
    }, {
      name: "description",
      content: "Create beautiful memory slideshows for birthdays, anniversaries, and special occasions. The perfect gift to cherish precious moments."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./folder-BcM-OwHH.js");
const Route$2 = createFileRoute("/folder")({
  head: () => ({
    meta: [{
      title: "Folder View — MemoryWall"
    }, {
      name: "description",
      content: "Review, reorder and edit labels for your event media."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./collect-C5FSguYL.js");
const Route$1 = createFileRoute("/collect")({
  head: () => ({
    meta: [{
      title: "Collect Memories — MemoryWall"
    }, {
      name: "description",
      content: "Create beautiful memory slideshows for birthdays, anniversaries, and special occasions."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-Dr6sti4T.js");
...
const PreviewRoute = Route$4.update({
  id: "/preview",
  path: "/preview",
  getParentRoute: () => Route$5
});
const LandingRoute = Route$3.update({
  id: "/landing",
  path: "/landing",
  getParentRoute: () => Route$5
});
const FolderRoute = Route$2.update({
  id: "/folder",
  path: "/folder",
  getParentRoute: () => Route$5
});
const CollectRoute = Route$1.update({
  id: "/collect",
  path: "/collect",
  getParentRoute: () => Route$5
});
